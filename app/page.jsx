    ...
    <div className="min-h-screen bg-white">
            ...
            <div className="flex items-center">
              <Link href="#">
                <div className="flex items-center space-x-2">
                  ...
                  />
                  <div className="text-2xl font-bold text-dark-gray font-funnel hero-font">
                    Invocea
                  </div>
                </div>
              </Link>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              <h1 className="text-6xl hero-font font-bold text-gray-900 font-funnel leading-tight">
                <span className="text-dark-gray">Track Time -</span>{" "}
                <span className="text-blue-600">Generate Invoice -</span>
                <span className="text-dark-gray">Get Paid</span>{" "}
              </h1>
      ...
      <section id="features" className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <h2 className="text-4xl lg:text-5xl font-bold text-dark-gray font-funnel mb-4">
          ...
          >
            {features.map((feature, index) => (
              <motion.div
                ...
                className="bg-gradient-to-br from-white to-gray-50/50 p-8 rounded-2xl border border-blue-200 shadow-lg hover:shadow-2xl hover:border-brand-blue/20 transition-all duration-500 group relative overflow-hidden"
              >
                <div className="bg-blue-600 w-16 h-16 rounded-2xl flex items-center justify-center mb-6">
                  <feature.icon className="w-8 h-8 text-white" />
                </div>
                <h3 className="text-xl font-bold text-dark-gray mb-3 font-funnel">
                  {feature.title}
                </h3>
                ...
                <div className="absolute inset-0 bg-gradient-to-br from-brand-blue/5 to-blue/5 opacity-0 group-hover:opacity-100 transition-opacity duration-500 pointer-events-none"></div>
              </motion.div>
            ))}
          </motion.div>
        </div>
          ...
          >
            {steps.map((step, index) => (
              ...
              >
                ...
                >
                  <h3 className="text-2xl font-bold text-dark-gray mb-4 font-funnel group-hover:text-blue-600 transition-colors duration-300">
                    {step.title}
                  </h3>
                ...
                <div className="absolute inset-0 bg-gradient-to-br from-brand-blue/5 to-blue/5 rounded-2xl opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none"></div>
              </motion.div>
            ))}
          </motion.div>
        </div>
        ...
        <div className="container mx-auto px-4 lg:px-8 relative z-10">
          ...
          >
            ...
            >
              <Button
                size="lg"
                className="bg-white text-dark-gray hover:bg-white/90 font-dm text-lg px-8 py-4 group shadow-xl"
              >
            ...
            >
              <div className="flex items-center space-x-2 mb-4">
                <div className="w-8 h-8 bg-gradient-to-br from-blue-700 to-blue-600 rounded-md overflow-hidden flex items-center justify-center">
                  <span className="text-white font-bold text-sm"><img src="/logo.png"/></span>
                </div>
